package hackerrank.hackerrankInterviewPreparation.day2.ex3;
...
public class Main {
    ...
    public static List<Integer> countingSort(List<Integer> arr) {
        List<Integer> countArr = new ArrayList<>(Collections.nCopies(Collections.max(arr) + 1, 0));
        for (Integer integer : arr) {
            countArr.set(integer, countArr.get(integer) + 1);
        }
